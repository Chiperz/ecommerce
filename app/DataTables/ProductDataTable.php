    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $editBtn = "<a href='".route('admin.product.edit', $query->id)."' class='btn btn-warning ml-2'><i class='fa fa-edit'></i></a>";
                $deleteBtn = "<a href='".route('admin.product.destroy', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='fa fa-trash'></i></a>";
